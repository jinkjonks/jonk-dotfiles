...
Sbar.exec(
"killall cpu_load >/dev/null; $CONFIG_DIR/helpers/event_providers/cpu_load/bin/cpu_load --quiet cpu_update 2.0")
Sbar.exec(
"killall memory_load >/dev/null; $CONFIG_DIR/helpers/event_providers/memory_load/bin/memory_load --quiet memory_update 2.0")
Sbar.exec(
"killall hdd_load >/dev/null; $CONFIG_DIR/helpers/event_providers/hdd_load/bin/hdd_load --quiet hdd_update 2.0")
